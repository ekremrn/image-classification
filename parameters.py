...
def get():
    ...
    parser.add_argument(
        "--save_path", default="results", type=str, help="Model and log path"
    )
    ...
    parser.add_argument(
        "--aug_mode", default="min", type=str, help="Augemntation modes: min, big"
    )
    ...
    parser.add_argument(
        ...
        default="resnet50",
        type=str,
        help="Could be used all the models in timm",
    )
    parser.add_argument(
        "--not_pretrained",
        action="store_false",
    ...
    parser.add_argument(
        "--optim", default="sgd", type=str, help="Optimization method to use"
    )
    parser.add_argument("--lr", default=0.01, type=float, help="learning rate")
    parser.add_argument("--momentum", default=0.9, type=float, help="momentum")

    parser.add_argument(
        "--scheduler", default="step", type=str, help="Optimization method to use"
    )
    ...
    parser.add_argument(
        ...
        default=0.0001,
        type=float,
        help="Cosine annealing min learning rate",
    )
    ...
    parser.add_argument(
        "--step_scheduler_gamma", default=0.1, type=float, help="scheduler_gamma"
    )

    parser.add_argument(
        "--wandb_entity", default="", type=str, help="keep it empty if wont use"
    )
